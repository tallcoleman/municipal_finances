...
from municipal_finances.fir_instructions.extract_changelog import app as fir_instructions_app
from municipal_finances.fir_instructions.extract_schedule_meta import app as extract_schedule_meta_app
